...
Only `styles.css` and this guide were vendored into area-overview; the
component demos, `theme.json`, `print-plates.js` and the templates listed
by the original remain in the Claude Design project.
