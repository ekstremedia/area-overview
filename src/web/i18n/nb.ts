...
export const nb = {
    ...
    'map.basemap.dark': 'mørkt kart',
    'map.basemap.light': 'standardkart',
    'map.basemap.satellite': 'satellitt',
    'map.basemapSwitchTo': 'Bytt til {name}',
    'map.locate.idle': 'Vis min posisjon',
    'map.locate.locating': 'Finner posisjonen din …',
    'map.locate.located': 'Kartet står på din posisjon',
    'map.locate.denied': 'Posisjon avslått. Gi nettleseren tilgang for å bruke denne.',
    'map.locate.unavailable': 'Fant ingen posisjon her.',
    ...
    'weather.dailyPrecipLegend': 'nedbør · hel søyle = {max} mm',
    'weather.dailyPrecipNone': 'nedbør · ingen ventet',
    ...
    'settings.map.useMyPosition': 'Bruk min posisjon',
